...
var Connection = function (url2play, org_url2play, streamType) {
    ...
    //We will send at least one media event after 100ms
    setTimeout(this.emit.bind(this, "media", this._media), 100);
    ...
    try{
        ...
        this._requestObject.on('error', function(e){
            console.log("MediaInformation - ICY connection error for "+this.url2play+": "+e);
        });
    } catch(e){
        console.log("MediaInformation - Cannot connect to "+url2play+": "+e);
    }   
}
...
function getMediaInfoListerner(callerId, url2play, org_url2play, streamType){
    ...
    if (!(url2play in activeConnections)) {
        var connection = new Connection(url2play, org_url2play, streamType);
