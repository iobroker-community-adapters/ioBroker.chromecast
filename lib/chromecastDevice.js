...
module.exports = function (adapter) {
    ...
    class ChromecastDevice {
        ...
        _playingPlayerStatus() {
            adapter.setState(`${this.mac}.status.playing`, {val: true, ack: true});
        }

        _stoppedPlayerStatus() {
            adapter.setState(`${this.mac}.status.playing`, {val: false, ack: true});
        }
            ...
            switch (id){
                ...
                case 'player.announcement':
                    this._mediaPlayer.playAnnouncementPromise(state.val)
                        .then(() => adapter.setState(namespace + '.player.announcement', {val: state.val, ack: true}))
